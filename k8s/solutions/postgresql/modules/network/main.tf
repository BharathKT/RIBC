...
module "gcp-network" {
  ...
  subnets = [
    {
      subnet_name           = "snet-gke-postgresql-asia-southeast1"
      subnet_ip             = "10.0.0.0/17"
      subnet_region         = "asia-southeast1"
      subnet_private_access = true
    },
    {
      subnet_name           = "snet-gke-postgresql-asia-southeast2"
  ...
  secondary_ranges = {
    ("snet-gke-postgresql-asia-southeast1") = [
      {
    ...
    ("snet-gke-postgresql-asia-southeast2") = [
      {
